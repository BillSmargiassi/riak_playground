...
package="Riak TS"
version="1.5.0"
rpm_dest_path="/vagrant/data/rpmcache/riak-ts-1.5.0-1.el6.x86_64.rpm"
rpm_download_path="http://s3.amazonaws.com/downloads.basho.com/riak_ts/1.5/1.5.0/rhel/6/riak-ts-1.5.0-1.el6.x86_64.rpm"
